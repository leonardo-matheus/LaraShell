...
use larashell_config_derive::{ConfigDeserialize, SerdeReplace};

use larashell_terminal::term::TermMode;
...
pub enum Action {
    ...
    /// Hide the LaraShell window.
    Hide,

    /// Hide all windows other than LaraShell on macOS.
    HideOtherApplications,

    /// Minimize the LaraShell window.
    Minimize,
    ...
    /// Spawn a new instance of LaraShell.
    SpawnNewInstance,
