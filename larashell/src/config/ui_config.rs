...
use larashell_terminal::term::Config as TermConfig;
use larashell_terminal::tty::{Options as PtyOptions, Shell};
use log::{error, warn};
...
use larashell_terminal::term::search::RegexSearch;
...
pub struct UiConfig {
    ...
    /// Config for the larashell_terminal itself.
