...
use larashell_terminal::term::{LineDamageBounds, TermDamageIterator};
...
/// Iterator which converts `larashell_terminal` damage information into renderer damaged rects.
