...
use larashell_terminal::grid::{BidirectionalIterator, Dimensions};
use larashell_terminal::index::{Boundary, Column, Direction, Line, Point};
use larashell_terminal::term::cell::Hyperlink;
use larashell_terminal::term::search::{Match, RegexIter, RegexSearch};
...
#[cfg(test)]
mod tests {
    use larashell_terminal::index::{Column, Line};
    use larashell_terminal::term::test::mock_term;
    use larashell_terminal::vte::ansi::Handler;
